...
if __name__ == "__main__":
    ...
    # Save solution to an output file named after the instance
    print(args.instance + ".out")
    with open(args.instance + ".out", "w") as f:
        f.write(tools.json_dumps_np(env.final_solutions))
